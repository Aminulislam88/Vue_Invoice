...
<template>
<body class="bg-gray-200 p-10 text-gray-600">
    <section class="mx-auto container bg-white border border-gray-400 min-h-screen p-12">
        <div class="flex justify-between">
            ...
            <div class="flex flex-col w-1/2 items-end">
                ...
                <input class="w-[200px] text-right" v-model="data.invoiceNumber" type="text" placeholder="Invoice Number">
                <div class="mt-10 flex-y-5 text-right space-y-3 w-full">
                    ...
                    <p>
                        ...
                        <input class="ml-2 w-[200px]" v-model="data.additionalNote" type="text">
                    </p>
                </div>
            </div>
        </div>
        <div class="mt-20">
            <table class="table-auto w-full">
                ...
                <tr v-for="(item, index) in data.items" :key="index">
                    <td class="py-1">
                        <input v-model="item.desciption" class="w-full pl-5" type="text" placeholder="Description" />
                    </td>
                    <td class="">
            ...
            <button @click="addMoreItems()" class="mt-5 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                Add More
            </button>
            <button @click="Object.assign(data,invoice1)" class="ml-3 mt-5 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                Invoice 1
            </button>
            <button @click="addDeteleItems()" class="ml-3 mt-5 bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                Delete
            </button>
            <P class="mt-5">
              {{ data }}
